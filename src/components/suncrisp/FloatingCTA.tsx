    ...
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-3 sm:p-4">
          ...
          {/* Modal Content */}
          <div className="relative w-full max-w-[calc(100%-24px)] sm:max-w-md bg-card border border-border shadow-2xl rounded-xl sm:rounded-2xl overflow-hidden animate-scale-in max-h-[90vh] overflow-y-auto">
            {/* Header */}
            <div className="p-4 sm:p-6 border-b border-border flex justify-between items-center bg-primary/5 sticky top-0 z-10">

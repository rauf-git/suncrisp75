...
const FeaturedProjects = ({ items, onItemClick, onViewAll, title = "Featured Projects", variant = "scroll" }: FeaturedProjectsProps) => {
            ...
            <div className="flex items-end justify-between mb-6">
              ...
              <div className="flex items-center gap-2">
                ...
                {onViewAll && (
                  <button 
                    onClick={onViewAll}
                    className="ml-2 group flex items-center gap-1.5 text-xs font-medium text-muted-foreground hover:text-primary transition-colors"
                  >
                    View All

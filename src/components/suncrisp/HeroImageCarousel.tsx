...
const HeroImageCarousel = ({
  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[3/4] sm:aspect-[4/3] md:aspect-[4/3] rounded-xl overflow-hidden shadow-2xl shadow-black/20 bg-muted/50 backdrop-blur-sm border border-primary/20">
